...
export const SelectCompoentCreate = ({
  isSearchable = false,
  ...
  const showClear = isClearable && value.length > 0;
                ...
                <div>
                  <div>
                    <Text
                      ...
                      py="3"
                    >
                      Пользователь ещё не зарегистрирован в Qubnix. Пригласить{" "}
                      {search} ?
                    </Text>
                    <Button
                      variant="solid"
                      onClick={() => {
                        console.log("Приглашение отправлено для:", search);
                        setSearch("");
                      }}
                      bg={"brand.500"}
                    >
                      Пригласить {search} в Qubnix
                    </Button>
                  </div>
                </div>
              )}
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        {!isMulti ? (
                          <Box w={"full"} borderRadius="full">
                            <Text
                              color={
                                isSelected ? "white" : "var(--text-default)"
                              }
                              borderRadius="full"
                              px="1"
                              maxW="220px"
